namespace RaceTrackerConsole
{
    ...
    public class Program
    {
        ...
        private static void PrintHelpMessage()
        {
            ...
            Console.WriteLine("\t-processdata -compile [filename] :=: Compiles all processed data into a single file with the given filename, provided that file does not exist.\n");
            Console.WriteLine("\t-processdata -append [filename] :=: Copies all processed data to a single file with the given filename, provided the file has not already been added.\n");
            Console.WriteLine("\t-processdata -move [filename] :=: Copies all processed data to a single file with the given filename, provided the file has not already been added, and deleting each file after it is added.\n");
            Console.WriteLine();
